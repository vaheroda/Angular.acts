...
export const routes: Routes = [
    ...
    {path: 'terminos-condiciones', component: TerminosComponent}, //TERMINOS Y CONDICIONES
    ...
    {path: 'services/solutions', component: MaintenanceComponent}, //VISTA DE MANTENIMIENTOS
